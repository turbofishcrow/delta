...
- **Update from cents/ratio**: The changed interval updates, and all other intervals shift to maintain their delta values
- **Update from delta**: The changed interval recalculates its cents/ratio, and other intervals shift while keeping their deltas fixed
