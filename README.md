...
- **Recalc deltas from intervals**: A global button that recalculates all deltas based on the current ratios (or as fallback, from cents values) — useful after manually entering multiple interval values
